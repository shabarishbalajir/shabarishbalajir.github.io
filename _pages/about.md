...
Research Interests
------
My research goal is to develop foundational models augmented with principled interpretability frameworks and physical constraints which will be essential in bringing data-driven models towards mainstream, production-quality software for widespread use. I am also fascinated by the rise of large language models and recent advances in agentic systems, and I aim to leverage these developments to build agentic frameworks that assist and accelerate scientific discovery. For a comprehensive overview of my research background, please refer to my [CV](/Shabarish_Balaji_PhD_Caltech_CMS_Resume.pdf). 
